            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, (lines
                            .map(function (_a) {
                            var text = _a.text, bbox = _a.bbox;
                            return ({
                                text: text.replace(/(^\s+|\s+$)/g, ''),
                                originalPosition: bbox,
                                dprPosition: index_1.getDprPositions(JSON.parse(JSON.stringify(bbox)), dpr),
                            });
                        })
                            .filter(function (element) { return element.text; }))];
            }
        });
    });
}
exports.default = ocrGetTextPositions;
